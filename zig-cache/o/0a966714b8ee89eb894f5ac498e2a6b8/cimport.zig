...
pub const __glibc_safe_or_unknown_len = @compileError("unable to translate macro: undefined identifier `__builtin_constant_p`"); // /usr/include/sys/cdefs.h:166:9
...
pub const RL_SETSTATE = @compileError("unable to translate C expr: expected ')' instead got: PipeEqual"); // /usr/include/readline/readline.h:910:9
pub const RL_UNSETSTATE = @compileError("unable to translate C expr: expected ')' instead got: AmpersandEqual"); // /usr/include/readline/readline.h:911:9
